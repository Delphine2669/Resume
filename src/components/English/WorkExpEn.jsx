function WorkExpEn() {
    return (
        <div id="WorkExp">
            <h2 className="overline">Work Experience</h2>
            <ul className="workE-list">
                ...
                <div className="job-block infoContent">
                    <li className="job-title">Computer technician </li>
                    <li> Maintaining and handling a company&apos;s micro-computing serving </li>
                    <li> Solved user problems :hardware and software</li>
                    <li>Diagnosed and detected bug and problem </li>
                    <li>Network administration on several systems :Windows XP, 2000</li>
                </div>
                <li className="jobDate infoDate">2016-2017</li>
