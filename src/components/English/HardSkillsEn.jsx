    ...
    return (
        ...
        <div id="HardSkills">
            ...
            <ul className="HSUl">
                ...
                <li className="eSItemIcon"><img src="/EcoSwitch-icon.png" alt="icone app LocalEat" className="vidIcons"></img></li>
                ...
                <div className="lESection">
                    <li className="lEItemIcon"><img src="/LocalEat-icon.png" alt="icone app LocalEat" className="vidIcons"></img></li>
