...
function App() {
  ...
  const hobbiesListFr = {
    ...
    photography: <a href='https://delphinethevenet.wordpress.com/portfolio-2/' target="_blank"rel="noreferrer">Photographe amatrice de paysages naturels et urbains depuis une dizaine d&apos;année</a>,
    travel: 'Hibernophile - Voyages à la découverte de différentes cultures Européennes',
    america: 'Passionnée de culture nord-américaine (histoire, lifestyle)',
    journalism: <a href='https://delphinethevenet.wordpress.com/articles/sparks-newspaper/' target="_blank" rel="noreferrer">Rédaction d&apos;articles dans un journal étudiant anglais</a>,
